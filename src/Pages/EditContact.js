...
const EditContact = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const res = await fetch(`https://contact-management-api-seven.vercel.app/api/contact`, {
      method: "PUT",
      headers: {
  ...
  useEffect(async () => {
    setLoading(true);
    try {
      const res = await fetch(`https://contact-management-api-seven.vercel.app/api/contact/${id}`, {
        method: "GET",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
